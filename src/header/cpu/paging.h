 ...
 * @param global_page     Is this page translation global & cannot be flushed? (1-bit)
 * @param ignored         Ignored bits (3-bit)
 * @param pat_support     Page Attribute Table support (1-bit)
 * @param higher_address  Bits 39:32 of address (4-bit)
 * @param reserved        Reserved bits (6-bit)
...
struct PageDirectory {
    volatile struct PageDirectoryEntry table[PAGE_ENTRY_COUNT] __attribute__((aligned(0x1000)));
} __attribute__((packed));
